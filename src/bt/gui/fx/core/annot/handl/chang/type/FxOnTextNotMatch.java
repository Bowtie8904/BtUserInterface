 ...
 *
 */
public class FxOnTextNotMatch extends FxStringChange<TextInputControl, String>
{
    /**
                                                        ...
                                                        Class<?> fieldObjType, String fieldName)
    {
        ...
        ChangeListener<String> defaultListener = getDefaultListener(fieldObj, handlingObj, handlerMethodName, withParameters, passField, regex, fieldObjType, fieldName);
