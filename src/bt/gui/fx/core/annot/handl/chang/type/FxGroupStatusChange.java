...
public class FxGroupStatusChange extends FxBooleanChange<Object, Boolean>
{
                                                 ...
                                                 Class<?> fieldObjType)
    {
        ...
        ChangeListener<Boolean> changeListener = getSpecialListener(fieldObj, handlingObj, handlerMethodName, withParameters, passField, groupName, fieldObjType);

        if (changeListener == null)
        {
            changeListener = getDefaultListener(fieldObj, handlingObj, handlerMethodName, withParameters, passField, groupName, fieldObjType);
        }
